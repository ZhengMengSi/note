...
init:function(){var p=this.getComponentData().config;var a="",T="",U="";a=p.SWA_PUB_TOKEN;T=p.SWA_BASE_URL;U=p.SWA_OWNER;this.loadSWAObject(a,T,true,U);this.loadWebGUI();},
