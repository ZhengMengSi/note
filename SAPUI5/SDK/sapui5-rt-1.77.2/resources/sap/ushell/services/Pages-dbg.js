...
sap.ui.define([
     ...
     * @private
     */
    Pages.prototype._getVisualizationData = function (sPageId, sVizId, mVisualizations, oAdditionalVizData, mApplications) {
        ...
        var oVizData = readVisualizations.getVizData(oSite, oVisualizationReference);
        if (!oVizData.id) {
                ...
                return Promise.all([
                    ...
                    .then(function (aResult) {
                        var sPagePath = aResult[0],
                            ...
                            oVisualizationData = this._getVisualizationData(sPageId, sVizId, aResult[1], null, aResult[2]);
                ...
                if (oNewSection.visualizations) {
                    ...
                    for (; i < oNewSection.visualizations.length; i++) {
                        ...
                        if (oVizData.isBookmark) {
                            oSection.viz[oVizData.id] = oVizData;
                        } else {
    ...
    Pages.prototype.resetPage = function (iPageIndex) {
        ...
        return this._oCdmServicePromise
            ...
            .then(function (aServiceResult) {
                var oVisualizations = aServiceResult[0];
                var oApplications = aServiceResult[1];
                var oCdmPage = aServiceResult[2];
                var oOriginalCdmPage = aServiceResult[3];
                var oOriginalPageModel = this._getModelForPage(oOriginalCdmPage, oVisualizations, oApplications);
    ...
    Pages.prototype._getModelForPage = function (page, visualizations, applications) {
        ...
        page.payload.layout.sectionOrder.forEach(function (sSectionId) {
            ...
            oCDMPageSection.layout.vizOrder.forEach(function (id) {
                var oVisualizationReference = oCDMPageSection.viz[id],
                    sVizId = oVisualizationReference.vizId,
                    oVisualizationData = oVisualizationReference.isBookmark ? oVisualizationReference : this._getVisualizationData(page.identification.id, sVizId, visualizations, oVisualizationReference, applications);
            ...
            .then(function (pagePath) {
                ...
                return this._oCdmServicePromise
                    ...
                    .then(function (page) {
                        ...
                        oSection.layout.vizOrder.push(oVisualizationModelData.id);
                        oSection.viz[oVisualizationModelData.id] = oVisualizationModelData;
                        // Save
