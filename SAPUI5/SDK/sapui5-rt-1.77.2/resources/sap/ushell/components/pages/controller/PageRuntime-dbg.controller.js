...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.pages.controller.Pages", /** @lends sap.ushell.components.pages.controller.Pages.prototype */ {
        ...
        onInit: function () {
            ...
            this._oVisualizationLoadingService
                .then(function (service) {
                    this._oResolvedVisualizationLoadingService = service;
                }.bind(this));
            ...
            this.getOwnerComponent().getPagesService().then(function (oPagesService) {
        ...
        _visualizationFactory: function (id, context) {
            if (this._oResolvedVisualizationLoadingService) {
                ...
                var oVisualization = this._oResolvedVisualizationLoadingService.instantiateVisualization(oData);
