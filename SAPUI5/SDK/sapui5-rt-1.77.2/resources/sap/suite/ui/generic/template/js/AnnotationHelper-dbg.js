sap.ui.define(["sap/ui/model/odata/AnnotationHelper",
	...
	"sap/ui/Global"
], function (AnnotationHelperModel, SmartField, Log, formatMessage, deepExtend, encodeXML, RuntimeFormatters, testableHelper) {
	"use strict";
...
*/
		...
		setRowHighlight: function (oTreeNode, sListEntitySet, fnCheckIsDraftEnabled) {
			...
			// Note: The two last parameters will not be evaluated by the formatter. They are just contained to ensure that the formatter is called on every change of the row context or the context of the message model
