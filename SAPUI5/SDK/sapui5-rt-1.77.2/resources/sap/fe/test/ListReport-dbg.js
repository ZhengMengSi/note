				...
				return Utils.mergeObjects(TemplatePage.create(ViewId, sEntityPath), {
					...
					assertions: {
						...
						iSeeFieldInVHDFilterBar: function(sFieldName, sFilterBarField, oExpectedState) {
							return OpaBuilder.create(this)
								.hasId(FilterBarVHDId + sFieldName + "::FilterBar::FF::" + sFilterBarField)
						...
						iSeeTableP13nMode: function(aModes) {
							return this._iSeeControlsP13nMode(TableId, aModes);
						},
						iSeeFilterBarP13nMode: function(aModes) {
							return this._iSeeControlsP13nMode(FilterBarId, aModes);
						},
						iSeeExportExcelOptions: function() {
							return this._iSeeExportExcelOptions(TableId);
						},
						iDoNotSeeExportExcelOptions: function() {
							return this._iDoNotSeeExportExcelOptions(TableId);
						},
