	...
	function(
		...
		function fnTemplateEditState(oFilterBar, oModifier) {
			var oThis = new JSONModel({
					id: DelegateUtil.getCustomDataProperty("localId", oFilterBar, oModifier),
					draftEditStateModelName: DelegateUtil.getCustomDataProperty("draftEditStateModelName", oFilterBar, oModifier)
				}),
		...
		ODataFilterBarDelegate.beforeAddFilterFlex = function(sPropertyName, oFilterBar, mPropertyBag) {
			...
			sEntitySetPath = "/" + DelegateUtil.getCustomDataProperty("entitySet", oFilterBar, oModifier);
			...
			return DelegateUtil.checkValueHelp({
