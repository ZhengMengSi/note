...
// ---------------------------------------------------------------------------------------
sap.ui.define(
	["sap/ui/mdc/library", "sap/ui/mdc/ChartDelegate", "./ODataMetaModelUtil", "sap/base/util/merge"],
		...
		ChartDelegate.retrieveAllMetadata = function(oModel, sPath) {
			...
			return Promise.all(aSetAndTypePromise)
				.then(function(aTypeAndSet) {
					...
					var aAnnoPromises = [util.fetchAllAnnotations(oMetaModel, sTypePath), util.fetchAllAnnotations(oMetaModel, sSetPath)];
