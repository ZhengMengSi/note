 ...
 */
sap.ui.define(
	["sap/ui/model/json/JSONModel", "sap/fe/macros/CommonHelper", "sap/fe/library"],
	function(JSONModel, CommonHelper, FELibrary) {
		"use strict";

		var CreationMode = FELibrary.core.CreationMode;
		/**
