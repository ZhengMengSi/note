		...
		return Controller.extend("sap.fe.templates.ListReport.ListReportController", {
			...
			*/
			...
			_getMergedContext: function(oContext, filterBarConditions) {
				...
				oFilterBarSV = NavigationHelper.addExternalStateFiltersToSelectionVariant(new SelectionVariant(), filterBarConditions);
				if (Array.isArray(oContext)) {
					var oSelectionVariant = CommonHelper.getMergedLineContexts(oContext, oFilterBarSV, undefined);
