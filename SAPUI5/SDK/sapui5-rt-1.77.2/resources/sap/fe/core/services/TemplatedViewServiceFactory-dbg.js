				...
				return oAppComponent
					...
					.then(function(oRoutingService) {
						...
						var oViewDataModel = new JSONModel(mViewData),
							oPageConfigModel = new JSONModel(MetaModelConverter.convertPage(oMetaModel, mViewData)),
						...
						Object.assign(oGlobalConfigData, oPageConfigModel.getData());
						...
						var oViewSettings = {
							...
							preprocessors: {
								xml: {
									bindingContexts: {
										entitySet: sEntitySet ? oTemplateModel.createBindingContext("/" + sEntitySet) : null,
