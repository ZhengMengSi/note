...
sap.ui.define([
	...
	SafeArea
		...
		Viewport.prototype._resizeSafeArea = function() {
			if (this.getSafeArea()) {
		...
		Viewport.prototype._handleResize = function(event) {
			...
			if (this.getShowSafeArea()) {
				this._resizeSafeArea();
			}
		...
		*/
		...
		Viewport.prototype._renderLoop = function() {
			...
			if (this.getScene()){
				var annotations = this.getScene().getAnnotations();
				if (annotations && annotations.size > 0) {
					annotations.forEach(function(annotation) {
						annotation._update(this);
					}.bind(this));
				}
			}
