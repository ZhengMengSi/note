...
sap.ui.define([], function() {
	...
	return {
		annotations: {
			 ...
			 *
			 * The annotation supports a <code>FetchValues</code> property. When it is set to 1, the table in the <code>ValueHelpDialog</code>
			 * is not populated on initial load. When it is set to 2, the table is populated with values on
			 * initial load.
			 *
