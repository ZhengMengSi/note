...
sap.ui.define([
	...
	function(jQuery, library, Core, ExportDialog, EventProvider, Device, SpreadsheetExport, Log, assert, ExportUtils) {
		'use strict';
		 ...
		 *          <li><code>version</code> (string) - Application version that creates the XLSX document (default: "1.77.2")</li>
		...
		var createDataSourceFromBinding = function(oBinding) {
			...
			if (typeof oBinding.getDownloadUrl == 'function') {
				...
				var bV4ODataModel = oModel.isA('sap.ui.model.odata.v4.ODataModel');
