 ...
 */
sap.ui.define([
	'sap/ui/core/library', 'sap/ui/mdc/p13n/AdaptationController', 'sap/ui/mdc/p13n/FlexUtil','sap/ui/base/SyncPromise', 'sap/ui/Device', 'sap/ui/core/Control', 'sap/base/util/merge', 'sap/base/util/deepEqual', 'sap/ui/model/base/ManagedObjectModel', 'sap/ui/base/ManagedObjectObserver', 'sap/base/Log', 'sap/ui/mdc/filterbar/FilterItemLayout', 'sap/ui/mdc/condition/ConditionModel', 'sap/ui/mdc/condition/Condition', 'sap/ui/mdc/util/IdentifierUtil', 'sap/ui/mdc/condition/ConditionConverter', 'sap/ui/layout/AlignedFlowLayout', 'sap/m/library', 'sap/m/MessageBox', 'sap/m/Button', 'sap/ui/model/json/JSONModel', "sap/ui/fl/write/api/ControlPersonalizationWriteAPI", "sap/ui/fl/apply/api/FlexRuntimeInfoAPI"
], function(coreLibrary, AdaptationController, FlexUtil, SyncPromise, Device, Control, merge, deepEqual, ManagedObjectModel, ManagedObjectObserver, Log, FilterItemLayout, ConditionModel, Condition, IdentifierUtil, ConditionConverter, AlignedFlowLayout, mLibrary, MessageBox, Button, JSONModel, ControlPersonalizationWriteAPI, FlexRuntimeInfoAPI) {
	"use strict";
	...
	FilterBar.prototype.init = function() {
		...
		this._oInitialFiltersAppliedPromise = new SyncPromise(function(resolve) {
	...
	FilterBar.prototype.getCurrentState = function() {
		//return this.waitForInitialization().then(function() {
			...
			aFilterItems.forEach(function(oFilterField, iIndex){
				aItems.push({
					id: oFilterField.getId(),//TODO: is id necessary??.. --> ItemBaseFlex can determine the item without id
	...
	FilterBar.prototype.triggerSearch = function() {
		this.waitForInitialization().then(function() {
			if (!this._oSearchPromise) {
				...
				this._oSearchPromise = new SyncPromise(function(resolve) {
	...
	FilterBar.prototype.waitForInitialization = function() {
		return SyncPromise.all([this._oInitialFiltersAppliedPromise, this._oMetadataAppliedPromise]);
	};
