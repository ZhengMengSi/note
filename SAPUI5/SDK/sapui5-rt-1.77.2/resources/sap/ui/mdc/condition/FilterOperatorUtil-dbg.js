...
function(
		...
		FilterOperatorUtil._mOperators = {
			strictEqual: new Operator({
				...
				parse: function(sText, oType, sDisplayFormat, bDefaultOperator) {
					sDisplayFormat = sDisplayFormat || "DescriptionValue";
					return Operator.prototype.parse.apply(this, [sText, oType, sDisplayFormat, bDefaultOperator]);
				},
		...
		/**
		 * Checks if only EEQ is supported. (<code>Field</code> case)
		 *
