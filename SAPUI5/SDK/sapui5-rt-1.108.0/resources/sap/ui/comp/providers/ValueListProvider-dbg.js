...
sap.ui.define([
	...
	ValueListProvider.prototype._onAnnotationLoad = function (mValueList) {
		...
		if (this.oControl.isA("sap.m.Input") && this.oControl.getShowSuggestion() && this._getDisplayBehaviour() === DisplayBehaviour.descriptionAndId) {
			this.oControl.setFilterFunction(FilterUtil.getSuggestionsFilter());
		}
