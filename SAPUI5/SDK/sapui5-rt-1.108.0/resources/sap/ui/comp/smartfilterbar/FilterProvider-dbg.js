...
sap.ui.define([
	...
	var FilterProvider = function(mPropertyBag) {
		...
		if (mPropertyBag) {
			this._sControlNumber = mPropertyBag.controlNumber;
	...
	FilterProvider.prototype._createFilterControlId = function(oFieldViewMetadata) {
		...
		// When we are in scenario of SmartTable with several tabs we need to provide different ids for the fields of each table
		if (this._sControlNumber) {
			sName += "-" + this._sControlNumber;
		}
