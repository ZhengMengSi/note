...
sap.ui.define(
    ...
    function (
        ...
        function processPrivateParams(oCard, oParams) {
            ...
            aParams.forEach(function (sParamName) {
              ...
              if (oCardParams[sParamName].type === "datetime" && !aSemanticDateFields.includes(sParamName) && !paramVal.includes("datetime")){
                if (oDataModel && oDataModel.oData) {
                  paramVal = oDataModel.oData.formatValue(paramVal, "Edm.DateTime");
            ...
            if (oCardParams._headerDataUrl && oCardParams._headerDataUrl.value) {
              ...
              oCardParams._headerDataUrl.value = oParams._headerDataUrl = headerURL;
            } else if (hasBatch && oCardParams._headerDataUrl ) {
              headerURLparams = _processURL(oCardParams, "_header", sFilterQuery, oCard.descriptorContent["sap.card"].type);
              headerURL = headerURLparams ? sCommonURL + "?" + headerURLparams : sCommonURL;
              oUrlVal.header = headerURL;
            }
            if (oCardParams._contentDataUrl &&  oCardParams._contentDataUrl.value) {
              ...
              oCardParams._contentDataUrl.value = oParams._contentDataUrl = contentURL;
            } else if (oCardParams._contentDataUrl ){
              contentURLparams = _processURL(oCardParams, "_content", sFilterQuery, oCard.descriptorContent["sap.card"].type);
              contentURL = contentURLparams ? sCommonURL + "?" + contentURLparams : sCommonURL;
        ...
        function semanticHeaderContentUrl (oCard, sType) {
          var oUrl = processPrivateParams(oCard);
        ...
        function getDateRangeValue(oValue, bIsParameter, sLabel) {
          ...
          if (oValue && bIsParameter) {
            ...
            if (oConditionInfo !== "DATE") {
              ...
              return oConditionInfo.values[0];
            }
          }
        ...
        return {
            ...
            semanticHeaderContentUrl: semanticHeaderContentUrl,
