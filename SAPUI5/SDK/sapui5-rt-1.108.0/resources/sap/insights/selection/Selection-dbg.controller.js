        ...
        return BaseController.extend('sap.insights.selection.Selection', {
            ...
            closeDialog: function () {
                CardHelper.getServiceAsync("UIService").then(function (oInstance) {
                    ...
                    oInstance.showCardPreview(this.orgCard);
                }.bind(this));
            },
            handleCardListItemPress: function (oEvent, oDynCard) {
                ...
                this.oCardHelperServiceInstance.getParentAppDetails(oModel.getProperty(this.currentCardPreviewPath)).then(function(oParentAppDetails) {
                    ...
                    oModel.setProperty("/parentAppUrl", oParentAppDetails.semanticObject);
                });
            },
            ...
            onEditInsightCardsDrop: function (oEvent) {
                ...
                if (iDragItemIndex !== iDropItemIndex) {
                    ...
                    var oCardRankObj = this._setCardsRanking(aCards, iDragItemIndex, iDropItemIndex);

                    try {
                        this._getSelectionFragment().setBusy(true);
                        this.oCardHelperServiceInstance.setCardsRanking(oCardRankObj)
                            .then(function (oUpdatedCards) {
                                var oModel = this.getView().getModel("view");
                                oModel.setProperty("/cards", oUpdatedCards);
                                oModel.setProperty("/cardCount", oUpdatedCards.length);
                                this._createOdataModelsforDialog(oUpdatedCards);
                            }.bind(this))
                            .finally(function () {
                                this._getSelectionFragment().setBusy(false);
                            }.bind(this));
            ...
            _setCardsRanking: function (aOrgCards, iDragIndex, iDropIndex) {
                var aCards = JSON.parse(JSON.stringify(aOrgCards)),
                    aCardsRank = [];
            ...
            refreshCardList: function () {
                this.oNavCon.setBusy(true);
                this.oCardHelperServiceInstance._refreshUserCards(this.isDeleteAllCardsEnabled()).then(function(){
                    this.initUserCards();
                }.bind(this));
            },
