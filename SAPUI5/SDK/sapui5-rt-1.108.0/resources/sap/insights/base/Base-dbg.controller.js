  ...
  function (
    ...
    return Controller.extend('sap.insights.base.BaseController', {
      ...
      _handleFilterTokenUpdate: function (oSourceField, bIsSemanticDate, oEvent) {
        ...
        var oDynamicDate;
        if (bIsSemanticDate && oSourceField) {
          ...
          oDynamicDate.openBy(oSourceField.getDomRef());
      ...
      getLabelForField: function (sParameterName, oValue, oSourceField) {
        if (sParameterName && oValue) {
          var oControl =  this.byId("hiddenFilterDDR");
      ...
      _onSemanticParameterDateChange: function(sProperty, oSourceField, oEvent) {
        ...
        var oManifestCard = this._oParentViewModel.getProperty("/oCard");
        var cardId = oManifestCard.descriptorContent["sap.app"].id;
        this.oDraftCardParams[cardId][sProperty].value = sValue.operator;
        this.oDraftCardParams[cardId][sProperty].label =  sValue.operator;

        oSourceField.getInnerControls()[0].setTokens([]);
        var bIsDateOperator = sValue.operator === "DATE";
        var oToken = new Token({
          key: bIsDateOperator ? sValue.values[0] : sValue.operator,
          text: bIsDateOperator ? sValue.values[0] : sValue.operator
        });
      ...
      _onSemanticFilterDateChange: function(sProperty, oSourceField, oEvent) {
        var sValue = oEvent.getParameter("value");
        var oLabelInfo = this.getLabelForField(sProperty, sValue, oSourceField);
