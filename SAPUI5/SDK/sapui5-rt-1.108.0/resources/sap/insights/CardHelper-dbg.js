...
sap.ui.define([
    ...
    function isSupported() {
        ...
        try {
            ...
            if (bInsightsEnabled && bProductHomeSupported && bComponentIdCorrect) {
    ...
    var CardHelperService = {
        ...
        getParentAppDetails: function (oCard) {
            ...
            return sap.ushell.Container.getServiceAsync("ClientSideTargetResolution").then(function(ClientSideTargetResolution) {
                ...
                if (oApp){
                    oParentApp.semanticObject = "#" + oApp.semanticObject + "-" + oApp.action;
    ...
    var UIService = {
        ...
        showCardPreview: function (oCard) {
            return this._getXMLView(PREVIEW_XML).then(function (oXMLView) {
                return oXMLView.getController().showPreview(oCard);
            });
        },
    ...
    return {
        getServiceAsync: function (sServiceName) {
            if (sServiceName === "UIService") {
                ...
                if (bIsSupported) {
                    return Promise.resolve(CardHelperService);
                }
