...
import ShareAPI from "sap/fe/macros/share/ShareAPI";
...
class ListReportController extends PageController {
	...
	handlers = {
		handleShareShortcut(this: ListReportController) {
			const shareAPI: ShareAPI = this.getView().byId("fe::Share") as ShareAPI;
			shareAPI.openMenu();
		},
