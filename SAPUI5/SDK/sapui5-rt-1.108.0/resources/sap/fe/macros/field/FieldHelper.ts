...
const FieldHelper = {
	...
	getPropertyContextForQuickViewForm: function (oDataFieldContext: any) {
		const sType = oDataFieldContext.getObject("$Type");
		if (
			sType === "com.sap.vocabularies.UI.v1.DataField" ||
			sType === "com.sap.vocabularies.UI.v1.DataFieldWithUrl" ||
			sType === "com.sap.vocabularies.UI.v1.DataPointType"
		) {
