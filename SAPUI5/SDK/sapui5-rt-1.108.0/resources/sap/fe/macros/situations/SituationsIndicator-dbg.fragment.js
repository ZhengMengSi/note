...
sap.ui.define(["sap/base/Log", "sap/fe/core/buildingBlocks/BuildingBlock", "sap/fe/core/buildingBlocks/BuildingBlockRuntime", "sap/fe/core/converters/MetaModelConverter", "sap/fe/core/helpers/BindingToolkit", "sap/fe/macros/ResourceModel", "sap/fe/macros/situations/SituationsPopover"], function (Log, BuildingBlock, BuildingBlockRuntime, MetaModelConverter, BindingToolkit, ResourceModel, SituationsPopover) {
  ...
  var SituationsIndicator = (_dec = defineBuildingBlock({
    ...
    SituationsIndicator.getSituationsNavigationProperty = function getSituationsNavigationProperty(context) {
      ...
      var situationsNavProp = situationsNavProps.length >= 1 ? situationsNavProps[0] : undefined; // only one navigation property may lead to an entity tagged as "BusinessSituation"
    ...
    _proto.getTemplate = function getTemplate() {
      ...
      var numberOfSituations = pathInModel("".concat(situationsNavProp.name, "/SitnNumberOfInstances")); // Indicator visibility
      ...
      var text = ifElse(greaterThan(numberOfSituations, 1), numberOfSituations, ""); // Button tooltip: "There is one situation" / "There are <n> situations"

      var tooltip = ifElse(equal(numberOfSituations, 1), ResourceModel.getText("situationsTooltipSingular"), fn("formatMessage", [ResourceModel.getText("situationsTooltipPlural"), numberOfSituations])); // 'press' handler
