  ...
  var UserCategoryManager = /*#__PURE__*/function () {
    ...
    _createClass(UserCategoryManager, [{
      ...
      value: function isFavActive() {
        return (this.sina.provider.id === "abap_odata" || this.sina.provider.id === "multi") && this.active; // return this.active;
      }
    }, {
      key: "setFavActive",
      ...
      value: function save() {
        ...
        this.personalizationStorage.saveNotDelayed().then(function () {
          ...
          // refresh of search dropdown listbox
          else if (!isSearchAppActive() && this.isLastFavActive() !== this.isFavActive()) {
            setTimeout(function () {
              window.location.reload();
            }, 2000);
          }
