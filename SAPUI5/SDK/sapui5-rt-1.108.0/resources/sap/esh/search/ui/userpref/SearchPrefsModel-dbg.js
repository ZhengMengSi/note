    ...
    _createClass(SearchPrefsModel, [{
      ...
      function asyncInit() {
        ...
        this.initializePromise = this.searchModel.initBusinessObjSearch().then(function () {
          ...
          _this.setProperty("/isMyFavoritesActive", _this.searchModel.isMyFavoritesActive());

          var sinaNext = _this.searchModel.sinaNext;

          if (_this.searchModel.isMyFavoritesActive()) {
      ...
      value: function initSubDataSources() {
        ...
        this.searchModel.getUserCategoryManager().then(function (userCategoryManager) {
          ...
          // const dataSources = this.searchModel.getProperty("/dataSources");

          var dataSources = _this2.searchModel.sinaNext.dataSources;
          dataSources = dataSources.filter(function (x) {
            return x.id !== "CD$ALL~ESH_TRANSACTION~";
          });
          dataSources.filter(function (x) {
            return x.type === _this2.searchModel.sinaNext.DataSourceType.BusinessObject || x === _this2.searchModel.appDataSource;
          }).forEach(function (x) {
          ...
          /*     for (const dataSource of dataSources) {
                      if (
                          dataSource.type !== this.searchModel.sinaNext.DataSourceType.BusinessObject ||
                          dataSource !== this.searchModel.appDataSource
                      ) {
                          continue;
                      }
                      newDS.push({
      ...
      value: function savePreferences() {
        ...
        if (this.searchModel.isMyFavoritesActive()) {
