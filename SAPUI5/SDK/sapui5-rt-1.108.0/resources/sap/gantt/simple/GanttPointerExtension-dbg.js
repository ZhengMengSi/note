...
sap.ui.define([
	...
	GanttPointerExtension.prototype.customBar = function (oConatiner,val,timeValue) {
		...
		var oDateFormat = DateFormat.getDateTimeWithTimezoneInstance({ pattern: oConatiner.getStatusBarDatePattern(), showTimezone: false }); //Returns a DateFormat instance for date
