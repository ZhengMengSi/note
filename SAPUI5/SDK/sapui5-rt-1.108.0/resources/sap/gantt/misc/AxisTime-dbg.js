			...
			if (largeIntervalTicks[0] !== null){
				for (iIndex = 0; iIndex < largeIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < largeIntervalTicks[iIndex].length; iInner++) {
						...
						label = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getUpperRowFormatter(), date));
				...
				for (iIndex = 0; iIndex < smallIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < smallIntervalTicks[iIndex].length; iInner++) {
						...
						if (ignoreTickFlag){
							...
							sLargeLabel = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getUpperRowFormatter(), changeDate));
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getLowerRowFormatter(), changeDate));
							changeDate = null;
						} else {
							sLargeLabel = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getUpperRowFormatter(), date));
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getLowerRowFormatter(), date));
						}
				...
				for (iIndex = 0; iIndex < smallDstIntervalTicks.length; iIndex++){
					for (iInner = 0; iInner < smallDstIntervalTicks[iIndex].length; iInner++){
						...
						if (bIgnoreTickFlag){
							...
							label = Utility.getLowerCaseLabel(Utility.getFormattedDate(this._oZoomStrategy.getLowerRowFormatter(), oChangeDate));
							oChangeDate = null;
						} else {
