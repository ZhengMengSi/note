...
sap.ui.define(["sap/ui/generic/app/navigation/service/SelectionVariant",
	...
	"sap/insights/CardHelper"
			...
			ListUtils, MultipleViewsHandler, StableIdHelper, MessageStripHelper, JSONModel, DetailController, PersonalizationControllerUtil, AddCardsHelper, CardHelper) {
					...
					handlers: {
						...
						*/
						...
						onAddCardsToRepository: function(oEvent){
							...
							var oAnalyticalCard = AddCardsHelper.createAnalyticalCardForPreview(oCardDefinition);
							CardHelper.getServiceAsync("UIService").then(function(oInstance){
								oInstance.showCardPreview(oAnalyticalCard.getManifest()).then(function(){
								});
							})
