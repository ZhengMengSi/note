...
sap.ui.define([
	...
	WorklistHandler, ShareUtils, controlHelper, FeLogger, ObjectPath, StableIdHelper, deepExtend, CreateWithDialogHandler, MultiEditHandler, SelectionVariant, AddCardsHelper, CardHelper) {
	"use strict";
			...
			return {
				...
				handlers: {
					...
					onAddCardsToRepository: function(oEvent){
						...
						AddCardsHelper.showColumnsForCardGeneration(oCardDefinition, oEvent.getSource()).then(function (oCard){
							CardHelper.getServiceAsync("UIService").then(function(oInstance){
								oInstance.showCardPreview(oCard.getManifest()).then(function(){
								});
							})
