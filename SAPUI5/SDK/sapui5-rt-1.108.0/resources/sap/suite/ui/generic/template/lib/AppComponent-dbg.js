...
sap.ui.define([
	...
	function getMethods(oAppComponent, oAppId) {
		...
		function setGlobalTemplateModels(){
			...
			oTemplateContract.oTemplatePrivateGlobalModel.setProperty("/generic/replaceShareWithLogo", true);
			var oMessageModel = sap.ui.getCore().getMessageManager().getMessageModel();
	 ...
	 * @returns {sap.suite.ui.generic.template.lib.AppComponent} instance of the Application Component
	 * @public
	 */
