...
sap.ui.define(["sap/ui/base/Object",
	...
	function getMethods(oTemplateContract, oNavigationControllerProxy) {
		...
		function fnInitSession(bIsFirst){
			...
			oTemplateContract.myIntentPromise = (oComponentData && oComponentData.feEnvironemt && oComponentData.feEnvironemt.getIntent && Promise.resolve(oComponentData.feEnvironemt.getIntent())) || oIntentFromShellPromise || Promise.resolve({
				semanticObject: "",
				action: ""
			});
