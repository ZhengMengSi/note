...
function e(i){var o=new I();var s=i.get_settings();var d={urlBuilderParameters:I.buildUrlBuilderParametersFor(i),frameUrl:s.url,frameWidth:s.width,frameHeight:s.height};return o.open(d).then(function(S){if(!S){return[];}var w;var h;if(S.frameWidth){w=S.frameWidth+S.frameWidthUnit;}else{w="100%";}if(S.frameHeight){h=S.frameHeight+S.frameHeightUnit;}else{h="100%";}return[{selectorControl:i,changeSpecificData:{changeType:"updateIFrame",content:{url:S.frameUrl,width:w,height:h}}}];});}
