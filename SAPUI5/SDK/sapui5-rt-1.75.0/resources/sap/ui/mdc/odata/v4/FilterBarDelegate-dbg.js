...
// ---------------------------------------------------------------------------------------
sap.ui.define([
	"sap/ui/mdc/FilterBarDelegate", 'sap/base/util/ObjectPath', 'sap/base/util/merge', 'sap/ui/mdc/odata/v4/FieldBaseDelegate', 'sap/ui/mdc/condition/FilterOperatorUtil',  "sap/ui/model/FilterOperator", "sap/ui/model/Filter", 'sap/ui/mdc/util/IdentifierUtil'
	], function (FilterBarDelegate, ObjectPath, merge, FieldBaseDelegate, FilterOperatorUtil, ModelOperator, Filter, IdentifierUtil) {
	"use strict";
	...
	ODataFilterBarDelegate._setModel = function () {
		...
		if (oModel) {
			this.detachModelContextChange(this._oDelegate._setModel, this);
			this._oDelegate._fModelProvided(oModel);
		}
	};

	ODataFilterBarDelegate._waitForMetaModel = function (oFilterBar, sModelName) {
		return new Promise(function(resolve, reject) {
			var sModelName = sModelName === null ? undefined : sModelName;
			...
			this._fModelProvided = resolve;

			oFilterBar.attachModelContextChange(this._setModel, oFilterBar);
