...
sap.ui.define([
	'sap/ui/core/Core', 'sap/ui/core/Control', './library', 'sap/m/library', 'sap/ui/events/KeyCodes', './ActionToolbar', 'sap/m/Text', 'sap/m/Title', 'sap/ui/core/format/NumberFormat', 'sap/ui/model/Sorter', 'sap/ui/core/dnd/DragDropInfo', "./table/TableSettings", "./table/GridTableType", "./table/ResponsiveTableType", "sap/m/ColumnHeaderPopover", "sap/ui/core/Item", "sap/m/ColumnPopoverSortItem"
], function(Core, Control, library, MLibrary, KeyCodes, ActionToolbar, Text, Title, NumberFormat, Sorter, DragDropInfo, TableSettings, GridTableType, ResponsiveTableType, ColumnHeaderPopover, Item, ColumnPopoverSortItem) {
	"use strict";
