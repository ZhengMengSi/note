...
sap.ui.define(['sap/ui/core/Element', "sap/base/Log"], function(Element, Log) {
	 ...
	 *
	 * @return {boolean} if true focus goes to the value help, if false it stays in the calling control.
	 *
	 * @since 1.75.0
	 * @public
	 ...
	 *
	 * @return {boolean} True if field help can be used for input validation
	 *
	 * @public
	 * @restricted sap.ui.mdc.field.FieldBase
	 * @since 1.75.0
