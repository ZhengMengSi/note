...
// ---------------------------------------------------------------------------------------
sap.ui.define([
	"sap/ui/mdc/p13n/FlexUtil", "sap/m/OverflowToolbarButton", "sap/m/OverflowToolbarLayoutData", "sap/base/util/merge", "sap/m/library", "sap/m/Menu", "sap/m/MenuButton", "sap/m/MenuItem"
], function(FlexUtil, OverflowToolbarButton, OverflowToolbarLayoutData, merge, MLibrary, Menu, MenuButton, MenuItem) {
	"use strict";
	...
	var TableSettings = {
		...
		createExportButton: function(sIdPrefix, mEventInfo) {
			...
			return new MenuButton(sIdPrefix + "-export", {
		...
		_moveItem: function(oControl, iDraggedIndex, iNewIndex, sMoveOperation) {
			sap.ui.require([
				...
				aChanges.push(FlexUtil.createMoveChange(oMovedField.id, oMovedField.name, iNewIndex, sMoveOperation, oControl));
