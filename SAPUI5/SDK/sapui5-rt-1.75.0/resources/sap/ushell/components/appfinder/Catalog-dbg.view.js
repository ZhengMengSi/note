...
sap.ui.define([
    ...
    sap.ui.jsview("sap.ushell.components.appfinder.Catalog", {
        oController: null,
        oVisualizationOrganizerHelper: new VisualizationOrganizerHelper(),

        formatPinButtonTooltip: function (
            sAddTileGroups,
            sAddTileToMoreGroups,
            aGroupsIDs,
            iAssociatedGroupsLength,
            sGroupContextModelPath,
            sGroupContextId,
            sGroupContextTitle
        ) {
            var sTooltip;
