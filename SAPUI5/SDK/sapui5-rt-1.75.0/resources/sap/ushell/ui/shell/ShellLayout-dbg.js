...
sap.ui.define([
...
], function (jQuery, Device, Control, Config, Storage, Log, CanvasShapesManager) {
    "use strict";
    ...
    ShellLayout.prototype.onAfterRendering = function () {
        ...
        // In cloud scenarios, the theme may be applied before the first rendering.
        // See also Shell.controller for canvas shapes redraws after the onThemeChange event.
        if (this.getEnableCanvasShapes() && sap.ui.getCore().isThemeApplied()) {
