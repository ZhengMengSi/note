...
sap.ui.define(
	...
	function(FilterOperatorUtil, Operator, Filter, FilterOperator, FEResourceModel) {
		"use strict";
		 ...
		 * individual state
		 * @alias sap.fe.macros.filter.EDITSTATE
		 * @readonly
		 * @enum {String}
		 * @private
		 * @sap-restricted
		...
		var EDITSTATE = {
			...
			ALL: {
				id: "ALL",
				display: FEResourceModel.getText("draft.ALL_FILTER")
			},
			/**
			...
			UNCHANGED: {
				id: "UNCHANGED",
				display: FEResourceModel.getText("draft.UNCHANGED_FILTER")
			},
			/**
			 * Own draft documents
			 * @private
			...
			OWN_DRAFT: {
				id: "OWN_DRAFT",
				display: FEResourceModel.getText("draft.OWN_DRAFT_FILTER")
			},
			/**
			...
			LOCKED: {
				id: "LOCKED",
				display: FEResourceModel.getText("draft.LOCKED_FILTER")
			},
			/**
			...
			UNSAVED_CHANGES: {
				id: "UNSAVED_CHANGES",
				display: FEResourceModel.getText("draft.UNSAVED_CHANGES_FILTER")
			}
		};
