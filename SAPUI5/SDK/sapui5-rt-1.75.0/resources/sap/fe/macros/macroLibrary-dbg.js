...
sap.ui.define(
	...
	function (XMLPreprocessor, PhantomUtil, Chart, Field, FilterField, FilterBar, Form, FormContainer, MicroChart, Contact, Table, ValueHelp) {
		"use strict";
		...
		var sNamespace = "sap.fe.macros",
			aControls = [Table, Form, FormContainer, Field, FilterBar, FilterField, Chart, ValueHelp, MicroChart, Contact].map(
				function (vEntry) {
