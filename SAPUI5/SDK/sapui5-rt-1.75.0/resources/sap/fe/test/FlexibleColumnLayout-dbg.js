				...
				actions: {
					iClickFirstColumnExpandButton: function() {
						return OpaBuilder.create(this)
							.hasId("application-" + sFlpAppName + "-component---appContent-midForward")
					...
					iClickLastColumnExpandButton: function() {
						return OpaBuilder.create(this)
							.hasId("application-" + sFlpAppName + "-component---appContent-midBack")
					...
					iClickLastColumnCollapseButton: function() {
						return OpaBuilder.create(this)
							.hasId("application-" + sFlpAppName + "-component---appContent-endForward")
							.doPress()
					...
					iClickFirstColumnCollapseButton: function() {
						return OpaBuilder.create(this)
							.hasId("application-" + sFlpAppName + "-component---appContent-beginBack")
							.doPress()
							.description("Seeing the Last Column Expand Button")
							.execute();
					}
				...
				assertions: {
						...
						return OpaBuilder.create(this)
							...
							.check(function(oButtons) {
								var bFound = oButtons.some(function(oButton) {
									return oButton.getId() === "application-" + sFlpAppName + "-component---appContent-midForward";
								});
								return bFound === false;
							}, true)
					...
					iDoNotSeeLastColumnExpandButton: function() {
						return OpaBuilder.create(this)
							...
							.check(function(oButtons) {
								var bFound = oButtons.some(function(oButton) {
									return oButton.getId() === "application-" + sFlpAppName + "-component---appContent-midBack";
								});
								return bFound === false;
							}, true)
					...
					iSeeNumberOfColumns: function(nCols) {
						...
						return OpaBuilder.create(this)
							.hasId("application-" + sFlpAppName + "-component---appContent")
							.check(function(oFCL) {
